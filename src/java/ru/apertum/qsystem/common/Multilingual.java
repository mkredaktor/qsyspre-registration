...
public class Multilingual {
    ...
    public Lng init(String lng) {
        ...
        if (sess.getAttribute(org.zkoss.web.Attributes.PREFERRED_LOCALE) == null && Executions.getCurrent().getHeader("accept-language") != null && !Executions.getCurrent().getHeader("accept-language").isEmpty()) {
            ...
            ln = sess.getAttribute(org.zkoss.web.Attributes.PREFERRED_LOCALE) == null ? "uk_UA"
    ...
    public static final Lng UA_LNG = new Lng("Український", "uk_UA");
    public static final ArrayList<Lng> LANGS = new ArrayList<>(
            Arrays.asList(
                    new Lng("Український", "uk_UA"),
                    new Lng("Русский", "ru_RU"), new Lng("English", "en_GB"), new Lng("English", "en_US"), new Lng("Español", "es_ES"),
